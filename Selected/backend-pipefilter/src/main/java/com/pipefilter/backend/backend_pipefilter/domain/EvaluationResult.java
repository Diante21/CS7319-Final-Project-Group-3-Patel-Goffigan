...
public class EvaluationResult {
    ...
    @Transient
    private Map<String, Long> filterTimings;
    ...
    public Map<String, Long> getFilterTimings() { return filterTimings; }
    ...
    public void setFilterTimings(Map<String, Long> filterTimings) { this.filterTimings = filterTimings; }
}